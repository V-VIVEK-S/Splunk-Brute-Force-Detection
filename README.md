...
(The full rockyou.txt wordlist can be downloaded from official sources, such as SecLists GitHub repo or Kali Linux built-in wordlists.)
...
- Hydra username list used in testing (user.txt).
- Splunk search queries for detection (Splunk Queries.txt).
- This README file.
